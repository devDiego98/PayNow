import type { ChargeRequest, ChargeResult, IPaymentProvider, NormalizedWebhookEvent, ProviderName, RefundRequest, RefundResult } from "../../types/provider.types";
export declare abstract class BaseProvider implements IPaymentProvider {
