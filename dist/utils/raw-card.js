...
exports.isRawCardEntryAllowed = isRawCardEntryAllowed;
/**
 ...
 */
function isRawCardEntryAllowed() {
    if (process.env.NODE_ENV === "production") {
        return false;
    }
    return process.env.ALLOW_RAW_CARD_IN_API !== "false";
}
//# sourceMappingURL=raw-card.js.map